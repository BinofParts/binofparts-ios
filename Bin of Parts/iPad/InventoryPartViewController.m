...
#import "InventoryPartViewController.h"
#import "PDKeychainBindings.h"
#import "constants.h"

@interface InventoryPartViewController ()

@end

@implementation InventoryPartViewController
...
- (IBAction)SaveButton:(id)sender{
    ...
    if (!qty) {
        [self alertStatus:@"Please provide qty" :@"Error!"];
    }
    else{
